...
<body >
 ...
 <div class="container">
    ...
    <div  class="tag-line" >
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><i class="fa fa-circle-o-notch"></i> WELCOME TO THE SHOPPING<i class="fa fa-circle-o-notch"></i> </h2>
                   </div>
               </div>
             </div>
      ...
      <div id="course-sec" class="container set-pad">
             <div class="row text-center">
                 <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                     ...
                     <p data-scroll-reveal="enter from the bottom after 0.3s">
                      If you have any questions, please feel free to email us, our customer service center is working for you 24/7.
					  <br />For more details. Email are given  below.
                         </p>
                 </div>
    ...
    <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 " data-scroll-reveal="enter from the bottom after 0.4s">
        ...
        <hr />
                    <div >
                        ...
                        <h4><strong>Email: </strong>Sabawaheem123@gmail.com</h4>
                    </div>
                    </div>
...
<!-- Script -->
     <!-- CONTACT SECTION END-->
    <div id="footer">
        Shopping Cart|  <a style="color: #fff" target="_blank">Design by : SABA</a>
    </div>
     <!-- FOOTER SECTION END-->
